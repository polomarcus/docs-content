...
Scaleway's Observability Cockpit allows you to monitor your applications and their infrastructure by giving you insights and context into their behavior. Cockpit also enables you to visualize your metrics and logs through a Grafana dashboard.
...
3. Click **Open dashboards** to open your Grafana managed dashboard. You are redirected to the Grafana website.
